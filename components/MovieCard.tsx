  ...
  return (
    <Link href={`/movies/${id}` as any} asChild>
      <TouchableOpacity className='w-[30%]'>
        <Image source={{ uri: poster_path ? `https://image.tmdb.org/t/p/w500${poster_path}` : `https://placeholder.co/600x400/1a1a1a/ffffff.png` }}  className='w-full h-52 rounded-lg' resizeMode='cover' />
